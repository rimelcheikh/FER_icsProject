...
def run_training():
  ...
  train_dataset = load_data.AffectNetCategorical(idx_set=0,
  ...
  val_dataset = load_data.AffectNetCategorical(idx_set=1,
  ...
  for i in range(1, args.epochs + 1):
      ...
      for batch_i, (imgs, targets, indexes) in enumerate(train_loader):
          ...
          if i >= args.relabel_epoch:
              ...
              print(label_idx)
              print(label_idx.cpu().numpy())
              print(train_loader.dataset.label[6664])
              print(train_loader.dataset.label[label_idx.cpu().numpy()])"""
